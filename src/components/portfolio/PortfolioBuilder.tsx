    ...
    <div className="space-y-5">
      ...
      {assets.length > 0 && (
        <div className="space-y-2">
          {/* Column labels */}
          <div className="grid grid-cols-[1fr_96px_28px] gap-3 px-3 py-1">
          ...
          {assets.map((asset) => (
            <div
              key={asset.id}
              className="group grid grid-cols-[1fr_96px_28px] gap-3 items-center px-3 py-2.5 rounded-lg border border-bg-border bg-bg-raised hover:border-white/10 transition-colors"
            >
              {/* Asset info */}
              <div className="flex items-center gap-3 min-w-0">
                <div className={clsx("num text-[9px] font-bold w-8 text-center flex-shrink-0", CLASS_COLOR[asset.assetClass])}>
              ...
              <input
                ...
                className="num w-full text-right bg-bg-surface border border-bg-border rounded-lg px-2.5 py-1.5 text-[13px] font-semibold text-ink focus:outline-none focus:border-brand/50 focus:ring-1 focus:ring-brand/20 transition-all"
              />
              ...
              <button
                ...
                className="w-7 h-7 rounded-md flex items-center justify-center text-ink-disabled hover:text-danger hover:bg-danger-muted transition-colors opacity-0 group-hover:opacity-100"
              >
